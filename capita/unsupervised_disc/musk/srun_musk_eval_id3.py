...
- Save result to "musk_evaluation_id3.txt"
'''
# Import 
import pandas as pd
import numpy as np
...
loaded_id3 = sio.load('musk_ID3_EWD_4.skops', trusted = True)
y_pred_id3 = loaded_id3.predict(x_test)

# Decomposition
f_path = f"{new_wd}/musk_evaluation_id3.txt"
f = open(f_path, "a")
import time
...
#loaded_id3 = sio.load('musk_ID3_EWD_7.skops', trusted = True)
y_pred_id3 = loaded_id3.predict(x_test)
...
print(model_name)
loaded_id3 = sio.load(model_name, trusted=True)
#loaded_id3 = sio.load('musk_ID3_FFD_30.skops', trusted=True)
y_pred_id3 = loaded_id3.predict(x_test)
...
print(model_name)
loaded_id3 = sio.load(model_name, trusted=True)
#loaded_id3 = sio.load('musk_ID3_FFD_60.skops', trusted=True)
y_pred_id3 = loaded_id3.predict(x_test)
...
print(model_name)
loaded_id3 = sio.load(model_name, trusted=True)
#loaded_id3 = sio.load('musk_ID3_FFD_100.skops', trusted=True)
y_pred_id3 = loaded_id3.predict(x_test)
