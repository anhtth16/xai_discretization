...
- Save result to "pageblock_evaluation_ewd_id3.txt"
'''
# Import 
import pandas as pd
import numpy as np
...
loaded_id3 = sio.load('pageblock_ID3_EWD_4.skops', trusted = True)
y_pred_id3 = loaded_id3.predict(x_test)

# Decomposition
f_path = f"{new_wd}/pageblock_evaluation_ewd_id3.txt"
f = open(f_path, "a")
import time
