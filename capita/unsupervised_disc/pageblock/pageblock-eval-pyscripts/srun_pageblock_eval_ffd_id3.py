...
- Save result to "pageblock_evaluation_ffd_id3.txt"
'''
# Import 
import pandas as pd
import numpy as np
...
# Decomposition
f_path = f"{new_wd}/pageblock_evaluation_ffd_id3.txt"
f = open(f_path, "a")
import time
...
print(model_name)
loaded_id3 = sio.load(model_name, trusted=True)
#loaded_id3 = sio.load('pageblock_ID3_FFD_30.skops', trusted=True)
y_pred_id3 = loaded_id3.predict(x_test)
...
print(model_name)
loaded_id3 = sio.load(model_name, trusted=True)
#loaded_id3 = sio.load('pageblock_ID3_FFD_60.skops', trusted=True)
y_pred_id3 = loaded_id3.predict(x_test)
...
print(model_name)
loaded_id3 = sio.load(model_name, trusted=True)
#loaded_id3 = sio.load('pageblock_ID3_FFD_100.skops', trusted=True)
y_pred_id3 = loaded_id3.predict(x_test)
